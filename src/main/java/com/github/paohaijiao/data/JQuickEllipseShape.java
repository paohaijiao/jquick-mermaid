 ...
 * @since 2026/5/2
 */
public class JQuickEllipseShape extends JQuickBaseShape {
    private double width, height;

    public JQuickEllipseShape(double x, double y, double width, double height, Color color, boolean filled) {
